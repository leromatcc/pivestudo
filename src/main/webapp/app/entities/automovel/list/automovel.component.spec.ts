...
import { sampleWithRequiredData } from '../automovel.test-samples';
import { AutomovelService } from '../service/automovel.service';

import { AutomovelComponent } from './automovel.component';
import SpyInstance = jest.SpyInstance;

describe('Automovel Management Component', () => {
  let comp: AutomovelComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(AutomovelComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.automovels?.[0]).toEqual(expect.objectContaining({ id: '9fec3727-3421-4967-b213-ba36557ca194' }));
  });

  describe('trackId', () => {
    it('Should forward to automovelService', () => {
      const entity = { id: '9fec3727-3421-4967-b213-ba36557ca194' };
      jest.spyOn(service, 'getAutomovelIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getAutomovelIdentifier).toHaveBeenCalledWith(entity);
