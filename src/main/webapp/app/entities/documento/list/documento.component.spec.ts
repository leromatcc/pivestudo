...
import { sampleWithRequiredData } from '../documento.test-samples';
...
describe('Documento Management Component', () => {
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.documentos?.[0]).toEqual(expect.objectContaining({ id: '9fec3727-3421-4967-b213-ba36557ca194' }));
  });
