...
describe('Imagem Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call registroAcesso query and add missing value', () => {
      ...
      const registroAcesso: IRegistroAcesso = { id: 'e9fb50be-93ad-42a2-92cd-dd5082be4269' };
      imagem.registroAcesso = registroAcesso;

      const registroAcessoCollection: IRegistroAcesso[] = [{ id: '48fe72ab-9f4c-4c50-bcda-a39283cd6d22' }];
    ...
    it('Should update editForm', () => {
      const imagem: IImagem = { id: '1361f429-3817-4123-8ee3-fdf8943310b2' };
      const registroAcesso: IRegistroAcesso = { id: '470f7b78-441f-41bb-86c4-03283e582180' };
      imagem.registroAcesso = registroAcesso;
