...
import { sampleWithRequiredData } from '../operacao.test-samples';
...
describe('Operacao Management Component', () => {
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.operacaos?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to operacaoService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getOperacaoIdentifier');
      const id = comp.trackId(entity);
      expect(service.getOperacaoIdentifier).toHaveBeenCalledWith(entity);
