...
import operacaoResolve from './operacao-routing-resolve.service';

describe('Operacao routing resolve service', () => {
  let mockRouter: Router;
  let mockActivatedRouteSnapshot: ActivatedRouteSnapshot;
  let service: OperacaoService;
  let resultOperacao: IOperacao | null | undefined;
  ...
  describe('resolve', () => {
    it('should return IOperacao returned by find', () => {
      ...
      TestBed.runInInjectionContext(() => {
        operacaoResolve(mockActivatedRouteSnapshot).subscribe({
          next(result) {
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultOperacao).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<IOperacao>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
